...
from .simplexml import Node,XMLescape,ustr
...
NS_MEDIA            ='urn:xmpp:media-element'                               # XEP-0221
...
NS_URN_BOB          ='urn:xmpp:bob'                                         # XEP-0231
NS_URN_SOFTWAREINFO ='urn:xmpp:dataforms:softwareinfo'                       # XEP-0232
